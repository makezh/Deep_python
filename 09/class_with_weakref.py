...
class Department:
    def __init__(self, employee):
        self.employee = weakref.ref(employee)
...
def main():
    if __name__ == "__main__":
        ...
        print("[WEAK_REF] Создание пачки экземпляров")
        start_1 = time.time()
        ...
        print("[WEAK_REF] доступ/изменениe/удалениe атрибутов")
        start_2 = time.time()

        for _ in range(N):
            worker = Employee("Name", 30)
            worker.name = "New_name_slots"
